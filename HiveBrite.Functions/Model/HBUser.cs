...
namespace HiveBrite.Functions.Model
{
    ...
    public class HBUsers
    {
        public List<HBUser> users { get; set; }
    }
    ...
    public class HBUser
    {
        ...
        public int[] sub_network_ids { get; set; }
        ...
        public int?[] citizenship_ids { get; set; }
        public string[] citizenship_country_codes { get; set; }
        public bool deceased { get; set; }
        public object deceased_at { get; set; }
        public HBUserPhoto photo { get; set; }
        public bool do_not_contact { get; set; }
        public object mobile_perso { get; set; }
        public string mobile_pro { get; set; }
        public object landline_perso { get; set; }
        public string landline_pro { get; set; }
        public HBUserPostal_Personal postal_personal { get; set; }
        public HBUserPostal_Work postal_work { get; set; }
        public string preferred_postal_address { get; set; }
        ...
        public HBUserLive_Location live_location { get; set; }
        ...
        public string share_mobile_pro { get; set; }
        public object share_mobile_perso { get; set; }
        public string share_landline_pro { get; set; }
        public object share_landline_perso { get; set; }
        public List<HBUserCustom_Attributes> custom_attributes { get; set; }
    }

    public class HBUserPhoto
    {
    ...
    public class HBUserPostal_Personal
    {
        public int id { get; set; }
    ...
    public class HBUserPostal_Work
    {
        public int id { get; set; }
        public string address_1 { get; set; }
        public string address_2 { get; set; }
    ...
    public class HBUserLive_Location
    {
        public string city { get; set; }
        public string country { get; set; }
    ...
    public class HBUserCustom_Attributes
    {
        public int id { get; set; }
        public string name { get; set; }
